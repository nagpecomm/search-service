...
import static com.ecommerce.search.util.Constants.Business.*;
import static com.ecommerce.search.util.ElasticsearchUtil.*;
...
public class QueryRules {
    ...
    public static final QueryRule RATING_QUERY =null;
//     QueryRule.of(
